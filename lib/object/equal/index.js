const EqualOptions = require("./equalOptions");
const EqualFalseResult = require("./equalFalseResult");

module.exports = function equal(v1, v2, options) {
  "use strict";

  const opt = Object.assign({}, new EqualOptions(), options);
  ...
  function isEqual(v1, v2, curKey) {
    ...
    if (Array.isArray(v1) || Array.isArray(v2)) {
      ...
      for (let i = 0; i < v1.length; ++i) {
        const r1 = isEqual(v1[i], v2[i], curKey);
        if (r1 !== true) {
          return r1;
        }
      }
    ...
    function checkKeys(keys) {
      for (let i = 0; i < keys.length; ++i) {
        const key = keys[i];
        const r2 = isEqual(v1[key], v2[key], key);
        if (r2 !== true) {
