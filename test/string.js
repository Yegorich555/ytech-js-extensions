...
describe('String', function() {
    ...
    describe('#equal', function() {
        ...
        it('false if only 1 is null', function() { assert.strictEqual(false, 's'.equal(null)); });
    });
    ...
    describe('#toCamelCase', function() {
        ...
        it('check if !this', function() { assert.strictEqual(undefined, String.prototype.toCamelCase.call()); });
    });
